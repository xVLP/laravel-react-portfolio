    ...
    <div class="cv-card">
        ...
        <div class="main">
            <div class="main-header">
                ...
                <div class="title-badge">COS Instructor & System Developer • Computer Vision Researcher</div>
            </div>
            ...
            <div class="main-section">
                ...
                <div class="summary-text">
                    Accomplished COS Instructor and former Program Chairperson at Central Bicol State University of Agriculture, with a proven track record in simplifying complex theories and enhancing students' practical coding logic. Demonstrated expertise as a Project Manager, Data Analyst, and Full-Stack & Mobile Developer at Bicol University, where notable achievements include developing an automated mobile application for Pili varietal classification using Convolutional Neural Networks and receiving the BUCS Best in Paper Award.
                </div>
            </div>
            ...
            <div class="main-section">
                ...
                <div class="timeline-item">
                    ...
                    <ul class="timeline-bullets">
                        <li><strong>Subjects Handled:</strong> Computer Programming 1 & 2, Basics of Computer Science, System Integration & Architecture 2, Integrative Programming, Information Assurance & Security 1, Capstone Project & Research 2, Multimedia Communication & IT.</li>
            ...
            <div class="main-section">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-desc">Completed 9-unit bridging program (DSA, OOP, Database Systems) and 12 units core-track (Artificial Intelligence, Digital Image Processing, Computer Vision, Data Visualization).</div>
                </div>
...
<?php /**PATH C:\Users\vlp\.gemini\antigravity-ide\scratch\laravel-react-portfolio\resources\views/cv.blade.php ENDPATH**/ ?>